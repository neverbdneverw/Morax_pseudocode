...
MODULE main(page: ft.Page)
    ...
    CALL HomeController(page, repository, home_page)
    CALL AddDialogController(page, repository, home_page)
    CALL ItemInfoDialogController(page, repository, home_page)
    CALL AddReceivableDialogController(page, repository, home_page)
    CALL AccountSettingsDialogsController(page, repository, home_page)
    CALL ReceivableInfoDialogController(page, repository, home_page)
    CALL AppearanceDialogController(page, repository, home_page)
    CALL CurrencyDialogController(page, repository, home_page)
    CALL OpeningController(page, opening_page)
    CALL OnboardingController(page, repository, onboarding_page)
    CALL LoginController(page, repository, login_page)
    CALL SignupController(page, repository, signup_page)
    CALL ForgotController(page, repository, forgot_password_page)
    CALL ConfirmEmailController(page, repository, confirm_email_page)
